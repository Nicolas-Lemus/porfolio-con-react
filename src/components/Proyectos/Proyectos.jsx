...
const Proyectos = () => {
  return (
    <>
        <div className='proyectos' id='action3'>
            <h2>Pro<span id='y'>y</span>ectos<span className='animate__animated animate__flash'>.</span><span className='animate__animated animate__flash2'>.</span><span className='animate__animated animate__flash3'>.</span></h2>
        </div>
        <section className='proyectos__description'>
            ...
            <button className='boton'><a href="https://nicolas-lemus.github.io/PF-Lemus/" target='blanck'>Visitar</a></button>
        </section>
        ...
        <section className='proyectos__description'>
            ...
            <button className='boton'><a href="https://proyecto-final-react-nicolas-lemus.netlify.app/" target='blanck'>Visitar</a></button>
        </section>
        <div className='cep'></div>
        <section className='proyectos__description'>
            <h3>🟢React Js🟢</h3>
            ...
            <button className='boton'><a href="https://tienda-fashion.netlify.app/" target='blanck'>Visitar</a></button>
            <div className='cep'></div>
        </section>
    </>
  )
